...
**Full Reference:** See `.claude/skills/karimo/karimo-firecrawl-web-tools.md` for:
...
See `.claude/skills/karimo/karimo-firecrawl-web-tools.md` for browser tool details.
