...
**External Research:** See `.claude/skills/karimo/karimo-external-research.md`
**Firecrawl Tools:** See `.claude/skills/karimo/karimo-firecrawl-web-tools.md`
...
**See:**
- `.claude/skills/karimo/karimo-external-research.md` — External research strategies
- `.claude/skills/karimo/karimo-firecrawl-web-tools.md` — Firecrawl tool reference
...
- Agent: `.claude/agents/karimo/karimo-refiner.md`
- Skill: `.claude/skills/karimo/karimo-external-research.md` (Phase 2)
- Skill: `.claude/skills/karimo/karimo-firecrawl-web-tools.md` (Firecrawl reference)
- Templates:
