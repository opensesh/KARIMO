...
This command (v8.2) implements the 5-phase execution model:
...
- **Phase 3.5 — Execution Configuration:** User configures review loops, bypass rules, review mode
...
*Generated by [KARIMO v8.2](https://github.com/opensesh/KARIMO)*
