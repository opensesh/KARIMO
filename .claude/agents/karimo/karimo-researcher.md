...
See `.claude/skills/karimo/karimo-firecrawl-web-tools.md` for full reference.
...
- **Firecrawl** (Recommended) — See `.claude/skills/karimo/karimo-firecrawl-web-tools.md`
  - `firecrawl_scrape` — Read documentation pages
  - `firecrawl_search` — Web search for best practices
  - `firecrawl_map` — Find pages on documentation sites
  - `firecrawl_extract` — Compare multiple libraries
...
- Skills:
  - `.claude/skills/karimo/karimo-research-methods.md` (internal research)
  - `.claude/skills/karimo/karimo-external-research.md` (external research)
  - `.claude/skills/karimo/karimo-firecrawl-web-tools.md` (Firecrawl reference)
- Related agents:
  - `.claude/agents/karimo/karimo-refiner.md` (processes annotations)
  - `.claude/agents/karimo/karimo-brief-writer.md` (inherits PRD research)
