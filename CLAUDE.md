...
| Location | Contents |
|----------|----------|
| `.claude/agents/` | 5 agent definitions (interviewer, investigator, reviewer, brief-writer, pm) |
| `.claude/commands/` | 5 slash commands (plan, review, execute, status, feedback) |
